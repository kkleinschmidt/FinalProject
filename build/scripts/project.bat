...
set CLASSPATH=%APP_HOME%\lib\project.jar;%APP_HOME%\lib\jgrapht-core-1.1.0.jar

@rem Execute project
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %PROJECT_OPTS%  -classpath "%CLASSPATH%" games.Main %CMD_LINE_ARGS%
